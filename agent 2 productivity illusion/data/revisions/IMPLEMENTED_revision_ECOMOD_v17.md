...
> model: parameters are representative, and the six predictions it makes are stated as falsifiable
...
model reproduces Scheffer's cases.
...
6. **The regeneration lag `τ_g` sets recovery vs collapse** (§8, v13–v17): on the corrected `(1‴)` S0 the
