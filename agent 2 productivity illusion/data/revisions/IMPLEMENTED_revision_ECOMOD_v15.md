...
**Empirical grounding of `τ_g` and the delay-response robustness sweep (v15).**
...
not measured. `τ_g` is the partial exception: it is now **field-banded** (§8, v15 empirical-grounding
