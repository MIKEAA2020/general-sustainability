...
production 240,000 kt/yr (USGS *Mineral Commodity Summaries* 2026, as tabulated in §6.5.3),
...
§6.5.1–6.5.4 of the article; the table collects them so that the promotion test is checkable in one
...
it remains an index, a ratio, or a pressure scale, which is the status §6.5 assigns.
...
Main counter 1–47, with the layering counter (Propositions 1–2) separate, per §3.1. Every statement numbered from 21 onward, with the section it sits in:
...
Two unnumbered notes sit alongside the inventory: *Certification state* in §3.1 and
...
checksums of the two tables as read: 60968f7c9959537f8e67f915aca4259662b5cd42c3a0ec02d094677b4c280ef6  NFA_2018_edition_kaggle.csv  11857080 bytes · 0dd766d975cd5e85f2a2d39cff1f914b92c514186ce507cb1f721a63be57b6a5  NFA_2017_edition_kaggle.zip.csv  13195855 bytes
