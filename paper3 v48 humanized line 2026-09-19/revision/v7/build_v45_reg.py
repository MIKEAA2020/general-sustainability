#!/usr/bin/env python3
r"""build_v45_reg.py - the v45 line: the corpus’s own wording where it can be proved to say the same thing, and the
...
self-reference words. `verify_v45_reg.py` proves it by comparing the numeral, label, citation and table multisets
...
def main():
    ...
    docs = {
        'article': ('paper3_material_ledgers_v42', 'paper3_material_ledgers_v45'),
        'supplementary': ('paper3_supplementary_v13', 'paper3_supplementary_v16'),
        'companionA': ('companionA_certification_procedure_v4', 'companionA_certification_procedure_v7'),
        'companionB': ('companionB_standards_horizon_v4', 'companionB_standards_horizon_v7'),
    }
    LOG = {}
    ...
    bt.transpile(f'{R}/paper3_supplementary_v16.md', 'paper3_supplementary_v16')
    print('  supplementary transpiled')
    for base in ('companionA_certification_procedure_v7', 'companionB_standards_horizon_v7'):
    ...
    head = texkit.header_for('Typed Flux Ledgers and Depletion Arithmetic: Conservation, Componentwise '
                             ...
                             'paper3_material_ledgers_v45.md')
    ...
    open(f'{R}/paper3_material_ledgers_v45.tex', 'w').write(tx)
    ...
    for base in ('paper3_material_ledgers_v45', 'paper3_supplementary_v16', 'companionA_certification_procedure_v7',
                 'companionB_standards_horizon_v7'):
    ...
    open(f'{R}/revisions_v45_reg_log.json', 'w').write(json.dumps(LOG, indent=1))
    print('\nlog: revisions_v45_reg_log.json')
    print('next: build_v45_package.py, then verify_v45_reg.py')
