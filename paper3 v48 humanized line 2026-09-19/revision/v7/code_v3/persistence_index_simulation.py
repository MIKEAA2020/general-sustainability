r"""Section 6.5.1 exhibit: boundedness of the persistence index on the declared linear-trend class.
...
Run:  python3 code/persistence_index_simulation.py      (from the top of the deposit)
"""
import numpy as np
...
def index_for_one_series(a):
    """Section 6.5.1's statistic: the fitted distance from the current level up to the series' own
