#!/usr/bin/env python3
r"""Build the supplementary package: the exhibit bundle restated for readers, and one archive of everything.
...
V3 = f'{R}/code_v3'
PKG = f'{R}/package_v1'
ZIP = f'{R}/paper3_supplementary_package_v1.zip'
...
def package():
    ...
    if os.path.isdir(PKG):
        shutil.rmtree(PKG)
    root = f'{PKG}/paper3_supplementary_package_v1'
    ...
    shutil.copy(f'{R}/paper3_supplementary_v13.ascii.md', f'{root}/manuscript/')
...
'''
    ...
    if os.path.exists(ZIP):
        os.remove(ZIP)
    subprocess.run(['zip', '-qrX', ZIP, 'paper3_supplementary_package_v1'], cwd=PKG, check=True, timeout=900)
