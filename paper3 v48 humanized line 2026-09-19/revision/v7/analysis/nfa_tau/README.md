...
asserted. This is the computation that Companion B's Section 7 named as the one thing standing between it being
a commentary and being a paper.
...
## Data provenance, stated the way the corpus requires
