...
% Supplementary material. Typeset from paper3_supplementary_v13.md; the LaTeX source, the markdown mirror and the compiled PDF are
...
\item \textbf{Theorems whose proofs rest on classical cited results:} Theorem 18 (first-passage law, Chhikara and Folks, 1989; Redner, 2001); Theorem 20 (It\(\ddot{o}\) lemma, \(\text{\O}\)ksendal, 2003); Theorem 10--11 (tangent-cone invariance, Aubin, 1991, in the compartmental lineage of Jacquez and Simon, 1993).
...
When a published ratio may be read as an event time. Every condition listed is stated somewhere in \(\S\)6.5.1--6.5.4 of the article; the table collects them so that the promotion test is checkable in one place, and it adds no condition.
...
Three of S7's `\texttt{discharged b\allowbreak{}y'' pointers\allowbreak{} name sectio\allowbreak{}ns that no l\allowbreak{}onger carry \allowbreak{}the statemen\allowbreak{}ts they cite\allowbreak{}; none of th\allowbreak{}e three is w\allowbreak{}rong in subs\allowbreak{}tance. The t\allowbreak{}able below g\allowbreak{}ives the lab\allowbreak{}els to read \allowbreak{}against the \allowbreak{}main text as\allowbreak{} it stands, \allowbreak{}and the }Typed` row is corrected in S15 rather than here.
