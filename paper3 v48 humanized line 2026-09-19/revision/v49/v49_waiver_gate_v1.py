...
def run(base_txt, built_txt, label, dep_txt=None):
    ...
    return {'comparison': label, 'built_sentences_in_region': ns, 'ledger_rows_in_section_1': nrow,
            'G0_integrity': f0, 'G1_vocabulary': f1, 'G2_ledger_trace': f2, 'G3_facts': f3, 'G4_G5_revert_and_cuts': f4,
...
def main():
    ...
    rep = run(bt, bu, f'{a.base} -> {a.built}')
