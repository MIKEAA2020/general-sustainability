r"""Section 7.1 exhibit: the compensation premium and the worst-concealed-deficit linear programme,
...
Run:  python3 revision/v5/code/certification_lp.py
"""
import itertools
import math
...
print("Section 7.1 exhibit - a two-component aggregate on declared bounds")
w = [0.5, 0.5]
...
cases = {
    "G3P anomaly-persistence index (S8.1)":
        [NOT, EST, NA, NA, NA, NA, NA, NA],
    "phosphate reserve-life ratio (S8.2)":
        [NOT, EST, NA, NA, NA, NA, NA, NA],
    "fisheries removals-only pressure time (S8.3)":
