...
src = Path('parallel_audits_evaluation.md')
out = Path('parallel_audits_evaluation.docx')
...
run = footer.add_run('Parallel-audit evaluation · 14 August 2026     ')
run.font.size = Pt(8)
