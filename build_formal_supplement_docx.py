...
src = Path('formal_supplement_A001_A002_A006_A010.md')
out = Path('formal_supplement_A001_A002_A006_A010.docx')
...
run = footer.add_run('Formal supplement · 17 August 2026     ')
run.font.size = Pt(8)
...
core.title = 'Formal Supplement: Restricted Viability, Information, Reduction, Network, and Audit Results'
core.subject = 'Formal theorem and audit supplement to the sustainability architecture'
core.author = '[Author name]'
core.comments = 'Formal supplement assembled under the non-loss and minimum-paper rules'
