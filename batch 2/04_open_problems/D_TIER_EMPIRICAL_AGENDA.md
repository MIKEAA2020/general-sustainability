...
|---|---|---|---|---|
| NAFO **2J3KL** | fisheries \(\Omega_{2016}\), \(\Omega_{\mathrm{xte}}\) | `wave_e_cod/` | A001/A014 class admitted; E5 does not transfer; kernel-level Cor2 **constructed 2026-08-26** (expansive-form erosion; no retention) | scored trees **YES** (`batch 4/WAVE_E_RERUN.md`); Cor2 leg **YES** (2026-08-26, byte-identical, same-env second session — `reaudit/intervention_rerun_cod/`) |
