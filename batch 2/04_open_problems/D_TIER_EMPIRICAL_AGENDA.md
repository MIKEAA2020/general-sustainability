...
| Edwards well **J-17** | groundwater \(\Omega_{\mathrm{SA}}\) | `wave_e_edwards/` | two-pool not constructed; H0 forecast-map Cor2 + kernel-level Cor2 (2026-08-26, erosion invoked; intervention leg executed) | scored trees **YES** (`WAVE_E_RERUN.md`) + intervention leg **YES** (2026-08-26, byte-identical — `reaudit/intervention_rerun/`) |
