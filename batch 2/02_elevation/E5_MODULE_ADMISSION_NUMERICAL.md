...
2. **It is not any real system.** Three distinct objects: (i) NAFO **2J3KL** northern cod (A014/A016; scored \(\Omega_{2016}/\Omega_{\mathrm{xte}}\) locally); (ii) Edwards well **J-17**, San Antonio Pool (scored \(\Omega_{\mathrm{SA}}\) locally — **not** rejected; the “confound-gate rejection” is withdrawn); (iii) A021 C4 **J-series** docket (not a basin). **No number in this file or in `E5_NUMBERS.json` transfers to any of them.**
