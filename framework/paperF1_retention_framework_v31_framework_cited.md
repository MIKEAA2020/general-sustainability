...
The Northern cod companion study (Abaee, 2026b) has itself adopted this framing at the suggestion of independent methodological review: its revised discussion presents the evaluation protocol of the present article as its transferable contribution under explicit attribution, while adding fisheries-native elements—target alignment to the quantities used in harvest control rules, an event-generation reading of collapse-window scores, and conservative stress-test evidence under a conditional hindcast. The two records are thereby distinguished by division of labour: this article defines the minimum reporting standard; the companion develops its domain-specific application.
...
* Abaee, A., 2026b. Does structural elaboration improve biomass forecasts? A pre-registered, power-aware out-of-sample evaluation of surplus-production models for Northern cod (Gadus morhua). Current version of the companion study in the author's public repository; the archived earlier draft under its working title is deposited at Zenodo. https://doi.org/10.5281/zenodo.22553609.
