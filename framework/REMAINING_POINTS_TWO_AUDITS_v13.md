...
- 2026-09-13 V12 (impact audits qwen+gpt) evaluated and verified jointly: JOINT_EVALUATION_IMPACT_AUDITS_V12.md — every claim checked against v25/archives (duplicates of done work identified: standard-vs-rule separation, rule-version disclosure, "proposes" wording); 8 contradictions adjudicated (NEW-10…17; AD4/Phase K, frozen labels, frozen ladder, pre-registration all bind); implementable remainder opened O18–O39 in phases L (text/spec), M (archive computations), N (artifacts), O (literature).
