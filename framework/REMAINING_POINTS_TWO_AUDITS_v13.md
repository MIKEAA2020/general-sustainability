...
4. **Phase B mandate.** Profound resolutions and root-cause analysis over shallow quick-fixes; honesty and novelty. Phase B is prepared in `PHASE_B_ROOT_CAUSE_DECISION_MEMO.md`; the owner decisions (AD6 reframe, AD2 rename, AD4 wording) are collected before any edit; the implementation is then a single coordinated pass producing v15.
