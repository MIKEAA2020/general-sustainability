...
|---|---|---|---|---|---|
| COD Spec A | NCAM M-shift SSB (DFO 2016 Table A2) | 1983–2015 | 25/21 | 884.6 kt | regime 240/120/5 kt three-level step (annual landings 172–269 kt) — C̄ training-mean catch plugged 5.00 kt coarse / 3.19 kt annual, C_t prescribed regime for M2 |
...
- `wave_e_cod/results/sim_misspecified_D6D7.csv` (Amendment 1: D6 r_t drifting, D7 obs-error-only, 4 cells 800 passes (4000 rows: 2 DGPs ×2σ×200×5 modules))
