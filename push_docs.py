...
FILES = [
    (f"{BASE}/paper2_evidence_gaps.md", "/home/user/arena agent 1/paper rewrites/latex/paper2_evidence_gaps.md"),
    (f"{BASE}/paper2_strengthening_prompt.md", "/home/user/arena agent 1/paper rewrites/latex/paper2_strengthening_prompt.md"),
]
...
for remote_path, local in FILES:
    ...
    payload = {"message": f"Add {os.path.basename(local)} (evidence-gap analysis + strengthening prompt)", "content": content}
