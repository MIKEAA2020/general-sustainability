...
check("cod consolidated file carries the consolidation note",
      "consolidated version" in COD and "verify_wave_e_consolidation.py" in COD)
check("edwards consolidated file carries the consolidation note",
      "consolidated version" in EDW and "verify_wave_e_consolidation.py" in EDW)
...
check("F1 phrase 'Promoting them is inflation' survives in Edwards manuscript",
      "Promoting them is inflation" in EDW)
...
cod_v1_only = [
    ...
    ("regime coarseness honesty", "not a hidden degree of freedom"),
    ("M4 information cost", "information cost of a one-year delay, not a coding error"),
    ...
    ("no licence to splice columns", "not a licence to splice columns"),
    ...
    ("computational protocol honesty", "computational protocol, not a locked clinical-style preregistration"),
    ...
    ("honest reading", "the pieces that are not identified do not go in"),
...
edw_v1_only = [
    ...
    ("status line (not earned)", "causal stock-flow is not earned, causal recharge forecasts are not earned"),
    ("oracle is a certificate", "oracle water-balance is a certificate, not a retain"),
    ...
    ("ENSO/rain not substitutes", "ENSO and last year's rain are not substitutes"),
    ("F1 phrase M2m class", "A numerical advantage for M2m is not extra structure"),
    ("F1 phrase pass-2 inflation", "Promoting them is inflation"),
    ("M2m demotion inflation sentence", "would be inflation"),
    ("thin retain", "thin retain (0.39 ft)"),
    ...
    ("declared APPROXIMATION defect", "declared APPROXIMATION defect, not a hidden one"),
    ("E5 not this specification", "E5 is not this specification"),
    ("Wave E support rule", "specification matching and independent verification"),
    ("honest reading", "the pieces that are not identified, or that arrive too late to be causal, do not go in"),
    ...
    ("mid-year nowcast protocol", "mid-year nowcast would be a new protocol"),
]
...
edw_v2 = [
    ...
    ("computational protocol honesty", "computational, not a locked clinical preregistration"),
    ("panel rebuild notes", "leaves the locked twenty-column panel in place"),
