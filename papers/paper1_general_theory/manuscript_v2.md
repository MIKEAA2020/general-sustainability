...
| Infra-1 | Finite-architecture robust transformation (recursion) | theorem (typed instance of established constructions — standing adjudication) | proved in `research_program/paper1_finite_architecture_transformation_theorem.md` | Paper 1 §3.3 (infrastructure) |
