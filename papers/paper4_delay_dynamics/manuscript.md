...
| CC-A003-014 | Thermodynamic-tether variant (registry entry) | registered obligation | same registry status | §8.3 |
...
No status is promoted anywhere in this ledger; the manuscript-native rows are restatements of the interface contract and this paper's local statements, not new results.
