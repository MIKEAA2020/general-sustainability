...
| CC-A018-003 | Nonnegative-orthant theorem (mass orthant, saturating-law scope) | theorem (exact specialization) | proof verified in source §6; row-verified 2026-08-28 | Paper 3 §3.6 |
...
Programme sources. The concordance inventory (`research_program/canonical_concordance_A001_A025.csv`; the 52 rows of §10 row-verified), the closure record (`research_program/concordance_row_closure_twenty_sources.md`), the ledger-to-dynamics interface contract (`research_program/A018_ledger_to_dynamics_interface_contract.md`), the programme's five-paper publication architecture (`research_program/revised_optimal_publication_architecture_A001_A025.md`), and the committed articles of record read alongside the uploads (`revised_articles/A019_closed_ledger_corrected.tex`, `A012_delay_dynamics_corrected.tex`, `A018_capital_liquidation_corrected.tex`, `A013_component_accounting_corrected.tex`, and `A024_first_passage_corrected.tex`), as listed in §11 (Sources).
