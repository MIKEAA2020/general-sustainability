...
No status is promoted anywhere in this ledger; the manuscript-native rows are restatements of the interface contract, not new results, and the paper asserts nothing beyond the statuses above.
