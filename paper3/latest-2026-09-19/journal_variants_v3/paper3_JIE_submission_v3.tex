...
\captionsetup[table]{labelfont=bf,labelsep=space,position=top}
...
\title{Typed material-flow ledgers for componentwise sustainability diagnostics}
\author{Amin Abaee\\[0.25em]
{\small Independent Researcher}\\[0.25em]
...
\section{A typed ledger for material-flow accounting}
...
\subsection{Incidence, closure and double counting}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=\linewidth]{typed_ledger_readout.png}
\caption{Typed ledger, readouts and aggregation failures. Typed compartments and routed fluxes produce separately certified readouts. A service is observable output, not conserved mass. A positive scalar aggregate and a high current yield are both compatible with component deficits or support-pool drawdown, so neither is a componentwise certificate}
\label{fig:typed-ledger}
\end{figure}
\section{Three certificates and the non-compensation result}
...
The statuses are \texttt{established}, \texttt{not established} and \texttt{not applicable}; an undeclared obligation is not called refuted. The first three layers are central to certification:
\begin{enumerate}
\item \textbf{Accounting consistency:} \(\dot x=S_{\mathcal T}v+b\) holds on the declared trajectory.
\item \textbf{Conservation consistency:} every declared conserved covector satisfies \(\ell^\top S_{\mathcal T}=0\).
\item \textbf{Barrier safety:} the readout remains inside declared componentwise bounds, \(\underline B(t)\le Cx(t)\le\overline B(t)\).
\end{enumerate}
...
\begin{enumerate}
\item construct and type-check \(S_{\mathcal T}\);
\item test the balance and conserved covectors;
\item test donor-limited positivity and declared barrier safety;
\item solve the closure or envelope programme when its inputs exist;
\item attach a source vintage and an evidence status to every readout.
\end{enumerate}
...
\subsection{Interpretation of certification status}
...
\section{Three depletion readings, one comparison table}
...
The comparison is summarized in Table~\ref{tab:depletion-readings}.
\input{table_depletion_readings_v3.tex}
...
\subsection{Conditions for interpreting a quotient as a horizon}
...
\section{Implications for industrial ecology}
...
\subsection{An industrial-ecology reading of the productivity illusion}
...
Mathematical proofs, extended public-data records, source-vintage material and reproduction procedures are provided in the supplementary material. Abaee (2026a) specifies the associated methods; Abaee (2026b) analyses accounting standards; and Abaee (2026c) analyses institutional delay dynamics. Public article record: \url{https://doi.org/10.6084/m9.figshare.33942451}.
...
\setlength{\topsep}{0pt}}
\item Abaee, A. (2026a). \emph{Certifying a Typed Ledger: The Predicates, the Programmes, the Vintages, and the Reproduction Bundle}. Figshare preprint. \url{https://doi.org/10.6084/m9.figshare.33942469}
\item Abaee, A. (2026b). \emph{What the Accounts Settle, and What They Leave Open: Depletion as a Cost of Production, and the Missing Step from a Rate to a Horizon}. Figshare preprint. \url{https://doi.org/10.6084/m9.figshare.33942487}
\item Abaee, A. (2026c). \emph{Delay-Induced Regime Change in Harvested Stocks: The Mobilising and Protective Channels of Institutional Feedback, and the Review Interval as Control}. Zenodo record. \url{https://doi.org/10.5281/zenodo.22554217}
\item Ahuja, R. K., Magnanti, T. L., \& Orlin, J. B. (1993). \emph{Network Flows: Theory, Algorithms, and Applications}. Prentice-Hall.
\item Brunner, P. H., \& Rechberger, H. (2004). \emph{Practical Handbook of Material Flow Analysis}. Lewis Publishers.
\item Daly, H. E. (1990). Toward some operational principles of sustainable development. \emph{Ecological Economics, 2}, 1--6.
\item Ekins, P., Simon, S., Deutsch, L., Folke, C., \& De Groot, R. (2003). A framework for the practical application of the concepts of critical natural capital and strong sustainability. \emph{Ecological Economics, 44}, 165--185.
\item Eurostat. (2001). \emph{Economy-wide Material Flow Accounts and Derived Indicators: A Methodological Guide}. Eurostat.
\item Feinberg, M. (2019). \emph{Foundations of Chemical Reaction Network Theory}. Springer.
\item Fischer-Kowalski, M., Krausmann, F., Giljum, S., et al. (2011). Methodology and indicators of economy-wide material flow accounting: State of the art and reliability across sources. \emph{Journal of Industrial Ecology, 15}, 855--876.
\item G{\"u}ntner, A., Sharifi, E., Haas, J., et al. (2024). Global Gravity-based Groundwater Product (G3P), v1.12. GFZ Data Services. \url{https://doi.org/10.5880/G3P.2024.001}
\item Illakwahhi, D. T., Vegi, M. R., \& Srivastava, B. B. L. (2024). Phosphorus' future insecurity, the horror of depletion, and sustainability measures. \emph{International Journal of Environmental Science and Technology, 21}, 9265--9280. \url{https://doi.org/10.1007/s13762-024-05664-y}
\item Jacquez, J. A., \& Simon, C. P. (1993). Qualitative theory of compartmental systems. \emph{SIAM Review, 35}, 43--79.
\item Munda, G., \& Nardo, M. (2009). Noncompensatory/nonlinear composite indicators for ranking countries: A defensible setting. \emph{Applied Economics, 41}, 1513--1523.
\item Neumayer, E. (2013). \emph{Weak versus Strong Sustainability: Exploring the Limits of Two Opposing Paradigms} (4th ed.). Edward Elgar.
\item Ricard, D., Minto, C., Jensen, O. P., \& Baum, J. K. (2012). Examining the knowledge base and status of commercially exploited marine species with the RAM Legacy Stock Assessment Database. \emph{Fish and Fisheries, 13}, 380--398.
\item Tilton, J. E. (2003). \emph{On Borrowed Time? Assessing the Threat of Mineral Depletion}. Resources for the Future.
\item Tilton, J. E., \& Lagos, G. (2007). Assessing the long-run availability of copper. \emph{Resources Policy, 32}, 19--23.
\item U.S. Geological Survey. (2026). \emph{Mineral Commodity Summaries 2026: Phosphate Rock}. USGS.
\end{list}
\end{document}
