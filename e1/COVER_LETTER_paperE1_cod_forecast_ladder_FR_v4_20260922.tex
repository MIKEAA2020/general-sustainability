...
\title{Cover letter — Paper E1, Fisheries Research (v4, 2026-09-22)}
...
\textbf{Title:} Does structural elaboration improve biomass forecasts? A
pre-registered, power-aware out-of-sample evaluation of
surplus-production models for Northern cod (Gadus morhua)
\textbf{Author:} Amin Abaee (Independent Researcher; ORCID
0000-0002-0019-1842; amin\_abaee@ut.ac.ir) \textbf{Journal:}
...
I present the manuscript \textbf{``Does structural elaboration improve
biomass forecasts? A pre-registered, power-aware out-of-sample
evaluation of surplus-production models for Northern cod''} (v66,
superseding the earlier ``Forecasting biomass under structural
non-stationarity'' carrier) for consideration in \emph{Fisheries
