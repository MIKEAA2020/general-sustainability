...
2. **A public reproducibility-repository habit.** All my working materials — including successive *draft carriers of this very manuscript* (markdown/LaTeX files named `paperE1_cod_forecast_ladder_v49` … `v58` and later) — sit openly in the repository **https://github.com/MIKEAA2020/general-sustainability**, and recent companion deposits sit on my figshare account (verified 2026-09-18 to contain none of this manuscript's text beyond 0.3%), because the paper's reproducibility commitments require the code, data, and carrier history to be public. Successive drafts of one study by one author naturally share very large stretches of text.
...
| My figshare deposits (2026-09-13/18: the framework companion paper, the Edwards Aquifer companion, and three mathematics papers) | Other studies of mine | Verified separately by 13-gram containment: every figshare deposit shares **≤0.3%** of the submitted manuscript's text; and the figshare deposit under the framework title (10.6084/m9.figshare.33922666) contains that paper's own files, not this manuscript |
...
## 5. Independent third-party audit (conducted 2026-09-19, after the similarity notification)

To rule out any genuine third-party overlap, I ran an exhaustive web audit of the manuscript's distinctive passages:

1. **No mirrored or re-hosted copies of this study exist outside my own channels.** Exact-phrase searches for the manuscript's distinctive strings (old working title, highlight sentences, and method formulations) and broker-site scans (ResearchGate, Semantic Scholar, OpenAlex, CORE, X-MOL-style aggregators) surface no copy of this text under any non-Abaee attribution — and no third-party work that the manuscript's text reproduces at scale.
2. **The only scholarly literature phrasings a similarity index can legitimately match are the standard formulations this field shares, each of which is cited in my reference list** — Hyndman and Koehler (2006) on MASE; Kell et al. (2016) and Kell et al. (2021) on hindcast prediction skill (Kell et al., 2016 is published in *Fisheries Research* itself); Carvalho et al. (2021) and Kokkalis et al. (2024) on diagnostic acceptance criteria; Diebold and Mariano (1995) on predictive accuracy testing; and the canonical Northern cod post-mortem and assessment literature (Hutchings and Myers, 1994; Walters and Maguire, 1996; Cadigan, 2016; Schijns et al., 2021; Regular et al., 2025; Rose, 2026; and others) that Section 1 and Section 2 set in context. A machine check of every in-text citation against the reference list returns **zero citation orphans** (14 of 14 in-text citation pairs resolve to reference entries).
3. **Every own deposit channel is now fully enumerated.** GitHub archive (draft carriers of this manuscript; dominant overlap), Zenodo records (same study under the old working title + companion studies), and figshare deposits (companion framework and Edwards Aquifer papers, each sharing ≤0.3% of the manuscript's text by 13-gram containment). All four channels carry the same sole author and ORCID 0000-0002-0019-1842.

I therefore maintain the explanation given above: the overlap reported by similarity screening is against my own publicly archived antecedents of this very manuscript, now explicitly declared and superseded in the v65 carrier.
