...
*In words.* The states where one plan works for every weight sit inside the states where, for each weight separately, some plan works. The reverse can fail — and §4.5 shows that it does.
