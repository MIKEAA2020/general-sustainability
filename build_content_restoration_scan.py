...
src = Path('content_restoration_scan.md')
out = Path('content_restoration_scan.docx')
...
run = footer.add_run('Deep content-restoration scan · 14 August 2026     ')
run.font.size = Pt(8)
