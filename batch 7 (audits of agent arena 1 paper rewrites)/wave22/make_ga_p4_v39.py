#!/usr/bin/env python3
"""Graphical abstract for paper4_delay_dynamics (v39, the retitle round).

Wave-22 / Task 98: the headline carries the retitled manuscript's new
title (two-line split, same layout slot); every panel, value, and layout
coordinate is the wave-10/11 original, byte-frozen.  Regenerates the
same three files (pdf/png/tiff) in place - the wave-11/12 asset
precedent (git history preserves the old bytes).
...
txt(W / 2, 40, "Governance delay and the stability of harvested stocks: mobilising and protective",
    size=fit("Governance delay and the stability of harvested stocks: mobilising and protective",
             W - 40, "bold", 9.0), color=DARK, weight="bold")
txt(W / 2, 13, "feedback rules, and the review interval as a design parameter",
    size=fit("feedback rules, and the review interval as a design parameter",
             W - 40, "bold", 9.0), color=DARK, weight="bold")
