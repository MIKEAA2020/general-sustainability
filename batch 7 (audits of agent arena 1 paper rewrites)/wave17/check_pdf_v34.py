#!/usr/bin/env python3
"""Wave-17 / Task 90, part 3: structural PDF verification of
paper4_delay_dynamics_v34.pdf (PyMuPDF), plus page renders for VLM
verification.
...
PDF = LATEX / "paper4_delay_dynamics_v34.pdf"
...
PAGE1_NEEDLES = [
    ...
    "amin_abaee@ut.ac.ir",
    "September 6, 2026",
    # abstract devices (the abstract opens on page 1)
    "governance delay",
...
# the abstract runs onto page 2; these must appear within pages 1-2
PAGES12_NEEDLES = [
...
def main() -> int:
    ...
    for i in range(n_pages):
        ...
        if regime_page is None and "The regime record is collected in one display" in t:
            regime_page = i
    ...
    print(
        ...
        f"{three_tier_page + 1}, declarations end on page {n_pages}"
    )
    return 0
