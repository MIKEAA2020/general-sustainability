...
src = Path('general_theory_of_sustainability_v0.1.md')
out = Path('general_theory_of_sustainability_v0.1.docx')
...
run = footer.add_run('Working manuscript · Version 0.1 · 14 August 2026     ')
run.font.size = Pt(8)
...
core.comments = 'Working manuscript, Version 0.1'
