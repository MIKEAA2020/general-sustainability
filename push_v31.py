...
FILES = [
    ...
    (f"{BASE}/paper2_v31_verification_report.md",
     "/home/user/arena agent 1/paper rewrites/latex/paper2_v31_verification_report.md"),
    (f"{BASE}/build_paper2_v31.py",
     "/home/user/build_paper2_v31.py"),
    (f"{BASE}/revisions_v31.py",
     "/home/user/revisions_v31.py"),
]
...
for remote_path, local in FILES:
    ...
    payload = {"message": f"Add {os.path.basename(local)} (v31: verified revision of the three Automatica routes)",
               "content": content}
    if sha:
        payload["sha"] = sha
