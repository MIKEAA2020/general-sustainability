...
src = Path('revised_sustainability_manuscript_v1.1.md')
out = Path('revised_sustainability_manuscript_v1.1.docx')
...
run = footer.add_run('Revised working preprint · Version 1.1 · August 2026     ')
run.font.size = Pt(8)
...
core.comments = 'Working preprint v1.1 — batch-5 corrections (hybrid-trajectory formula repair, ten-indicator rationale, assume-guarantee citation)'
