...
| Frozen intervention protocol | `wave_e_edwards/protocol_intervention.md` | `c4dd8d090169f233fb892ec4f5152b28c6712314aaa3892095715e2ecc090818` | text; locked before scores | `INDEPENDENT_RERUN` of the executed protocol 2026-08-26 (`reaudit/intervention_rerun/`) |
| Intervention runner | `wave_e_edwards/src/run_intervention.py` | `227fffe7f06d4bbb2aff8dbcc7eadd76b2dc97e70e384efd6e97880a49dcd9bf` | deterministic; no randomness | `INDEPENDENT_RERUN` 2026-08-26 (byte-identical; `reaudit/intervention_rerun/`) |
| Intervention results | `wave_e_edwards/results/intervention_results.json` | `41712fdc653fa05a39b41634137adfe2744b7eadcc1af76c57098316cff7a6b1` | `cd wave_e_edwards && python3 src/run_intervention.py` (uses committed `annual_panel.csv` only) | `INDEPENDENT_RERUN` 2026-08-26 (byte-identical; `reaudit/intervention_rerun/`) |
| Intervention boundary table | `wave_e_edwards/results/intervention_boundaries.csv` | `57ddb684d83b93b5ecd20c968c8fea9f5b078cbda54376a0c7a79999414061be` | same | `INDEPENDENT_RERUN` 2026-08-26 (byte-identical; `reaudit/intervention_rerun/`) |
| R04.Cor2 kernel-level row | `wave_e_edwards/admission/R04_Cor2_edwards_kernel.md` | `4b5de5773b430026d373f79ff92654cd1c86dabf49b9d3bbc046725b82d75534` | text; `APPROXIMATION` — governed one-pool object, Cor2 triple computed, erosion conversion invoked; **not** a two-pool kernel, **not** exact | `INDEPENDENT_RERUN` of its numbers 2026-08-26 (byte-identical artifacts) |
| Intervention manuscript | `wave_e_edwards/manuscript/wave_E_edwards_intervention.md` | `5eeb1973b78536a73e76dc670ba337f0b72a468225fccbf402eca0a61dbfbb61` | prose | `INDEPENDENT_RERUN` of scores 2026-08-26 (byte-identical artifacts; limitations section updated to record the rerun) |
