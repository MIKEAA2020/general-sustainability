...
| Working manuscript | `wave_e_cod/manuscript/wave_E_cod_forecast_ladder.md` | `54288a791eb8d962fe66d801b8555cfc22bf4375415646df44806f2ea1544bda` | prose; figures via `python3 src/make_figures.py` | `INDEPENDENT_RERUN` (`batch 4/WAVE_E_RERUN.md`) |
...
| Working manuscript | `wave_e_edwards/manuscript/wave_E_edwards_forecast_ladder.md` | `124e0034526260313893e25221313e5d0d95e5f94cf0c84c7b841619cca8d597` | prose; figures via `python3 src/make_figures.py` | `INDEPENDENT_RERUN` (`batch 4/WAVE_E_RERUN.md`) |
