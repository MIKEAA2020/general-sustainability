...
|---|---|---|
| P1 | Obstruction calculus — theory main line (`paper2_obstruction_calculus_v55_Automatica_routes.tex`) | `Formalizations.P1_Obstruction` |
| comp | Computational certification (`paper2_computational_certification_v18.tex`) | `Formalizations.Comp_Certification` |
| ws | Worked systems (`paper2_worked_systems_v17.tex`) | `Formalizations.WS_WorkedSystems` |
| minimax | Minimax dual certificates (`minimax_dual_certificates_v11.tex`) | `Formalizations.Minimax_Dual` |
| ebc | Exact belief computation (`paper2_exact_belief_computation_v10.tex`) | `Formalizations.EBC_ExactBelief` |
| P3 | Probabilistic sufficiency (`paper2_probabilistic_sufficiency_v11.tex`) | `Formalizations.P3_ProbSufficiency` |
| ARV | Applied regime viability (`applied_regime_viability_v9.tex`) | `Formalizations.ARV_RegimeViability` |
