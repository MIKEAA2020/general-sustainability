...
src = Path('general_theory_of_sustainability_manuscript.md')
out = Path('general_theory_of_sustainability_manuscript.docx')
...
run = footer.add_run('Working manuscript · 14 August 2026     ')
run.font.size = Pt(8)
...
core.comments = 'Working manuscript'
