...
This supplementary accompanies the main article on delay-induced regime change in harvested stocks. It carries four bodies of material that the main article only summarises: the computational protocol for the interval Hopf enclosures and the collocation formulation, the fold-certificate gap documentation, the stress-test frame that disciplines transfer of bifurcation readings to sustainability claims, and the registered open problems. Each item is reported at its declared status — theorem, conditional statement, re-execution-verified nominal computation, or open task — without escalation. Where a claim is provisional, the supplementary says so explicitly.
