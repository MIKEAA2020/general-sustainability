#!/usr/bin/env python3
"""
Computational viability certification, edition 7 — verification.
...
paper2_computational_certification_v7.tex, the separate declaration
...
deterministic.
Run: python3 paper2_computational_certification_v7_verification.py
"""
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v7.tex",
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v7.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_computational_certification_v7_verification.py",
    ...
    "brake \\emph{through} the blind window",
]
...
FORBIDDEN = ["in the sup-norm and absolutely", "sup-norm label continuity",
