...
tex = open(os.path.join(HERE, "paper2_probabilistic_sufficiency_v9.tex"),
           encoding="utf-8").read()
...
NEEDLES = [
    ...
    "paper2_probabilistic_sufficiency_v8_verification.py",
    "with six results",
...
hyg = True
for fn in ("paper2_probabilistic_sufficiency_v9.tex",
