...
paper2_computational_certification_v9.tex, the separate declaration
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v9.tex",
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v9.tex"),
           encoding="utf-8").read()
tex_raw = tex
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_computational_certification_v9_verification.py",
