% LaTeX source generated from paper2_obstruction_calculus_v13.md by wave13/build_latex_v13.py (batch 7 (audits of agent arena 1 paper rewrites)/wave13).
...
% beneath the name; date September 10, 2026.
...
Abaee, A.: The limits of compensatory aggregation: a formal separation
of weak and strong sustainability assessment. Zenodo.
https://doi.org/10.5281/zenodo.22545740 (2026). Companion
...
Verification code for the worked examples is available from the authors on request.
