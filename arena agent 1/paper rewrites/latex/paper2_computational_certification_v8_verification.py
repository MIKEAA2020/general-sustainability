#!/usr/bin/env python3
"""
Computational viability certification, edition 8 — verification.
...
paper2_computational_certification_v8.tex, the separate declaration
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v8.tex",
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v8.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_computational_certification_v8_verification.py",
...
check("affine-kernel refinement identity: e = sum |J|^2/4 exactly (two-block "
      "26/100; a four-block non-uniform aligned mesh reproduces the closed "
