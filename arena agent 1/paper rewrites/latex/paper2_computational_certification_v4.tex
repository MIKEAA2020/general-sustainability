...
program, and halts on the first positive certificate.
...
every other row lies at or below the same value; the campaign script checks
all \(465\) rows exactly at this mesh, and the row slacks are archived
with it (Section~\ref{methods}).
...
drop below the exact continuous margin once the moment error vanishes. All dimension counts
