...
paper2_computational_certification_v5.tex, the separate declaration
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v5.tex",
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v5.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
