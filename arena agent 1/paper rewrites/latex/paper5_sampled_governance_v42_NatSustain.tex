% The decision clock (paper 5, revision v42): audit-sweep corrections (figure paths, Table-3 theta/lambda pointers, section 3.7 heading, supplementary-file pointer) with line numbers for review.
