% Periodic Review as Sampled Governance (paper 5, revision v30): screen verification and battery repair revision with line numbers for review.
...
3.3 \\
Screen target bands A (2.5--5 yr) and B (5--9 yr) & Prespecified
...
Anchoveta--ENSO association: 3.7 yr peak, detrended-NINO1 \(r = -0.31\)
...
accompanying file \texttt{paper5\_supplementary\_v8.md}): the statement
...
power-simulation code and seeds are deposited with the article. The stage-map reconstruction of Section 3.4 is
