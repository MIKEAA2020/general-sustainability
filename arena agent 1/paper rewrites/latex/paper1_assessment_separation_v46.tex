...
where \(\mathcal{A}_\kappa\) denotes the augmented menu. \textbf{Proposition 10 (rescue threshold).} \emph{On the witness datum, for every \(z \in X_0\),}
