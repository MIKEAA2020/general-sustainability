...
typically targets the \emph{choice} of weights. A complementary methodological strand avoids weights altogether, constructing composite indices from Pareto fronts (Gao et al., 2023). The stronger possibility, established here, is that no choice of weights repairs the difficulty. The failure is structural --- it lies in
