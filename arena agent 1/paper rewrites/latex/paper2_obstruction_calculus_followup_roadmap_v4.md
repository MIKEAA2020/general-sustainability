# Paper 2 — Obstruction Calculus: Follow-up Roadmap (v4)
...
| --- | --- | --- |
| 1 | A1 sweep ✓ (v45) + A4 sweep ✓ (v45; Gaps 5/8 closed v47) + A3 editorial sweep (open — planned v48) → Automatica submission | nothing |
