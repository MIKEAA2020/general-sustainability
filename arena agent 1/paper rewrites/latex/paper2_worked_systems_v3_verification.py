#!/usr/bin/env python3
"""
Worked-systems audit, edition 3 — verification.
...
paper2_worked_systems_v3.tex.

Exact rational/integer arithmetic; stdlib only; deterministic.
Run: python3 paper2_worked_systems_v3_verification.py
"""
...
tex = open(os.path.join(HERE, "paper2_worked_systems_v3.tex"), encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
...
check("declarations use separate headings with the responsibility wording",
      ...
      and "paper2_worked_systems_v3_verification.py" in tex)
