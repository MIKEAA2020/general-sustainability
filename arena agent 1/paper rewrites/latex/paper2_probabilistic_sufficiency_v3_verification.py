#!/usr/bin/env python3
"""
Probabilistic sufficiency for the obstruction calculus — edition 3 verification.
...
tex = open(os.path.join(HERE, "paper2_probabilistic_sufficiency_v3.tex"),
           encoding="utf-8").read()
tnorm = " ".join(tex.split())

NEEDLES = [
    "Probabilistic Sufficiency for the Obstruction Calculus",
    "carried entirely in exact rational arithmetic, with five results",
    ...
    "moment- or distance-based ambiguity sets",
    "paper2_probabilistic_sufficiency_v3_verification.py",
    "September 26, 2026",
]
...
hyg = True
for fn in ("paper2_probabilistic_sufficiency_v3.tex",
