...
tex = open(os.path.join(HERE, "paper2_worked_systems_v13.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_worked_systems_v13_verification.py",
    ...
    "distinct-subproblem counts", "paper2_worked_systems_v13_verification.py",
