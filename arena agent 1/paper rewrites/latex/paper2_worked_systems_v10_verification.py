#!/usr/bin/env python3
"""
Worked-systems audit, edition 10 — verification.
...
Run: python3 paper2_worked_systems_v10_verification.py
"""
...
tex = open(os.path.join(HERE, "paper2_worked_systems_v10.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_worked_systems_v10_verification.py",
