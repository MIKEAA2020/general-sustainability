#!/usr/bin/env python3
"""
Exact belief-state computation at scale II — edition 4 verification.

Re-derives every claim of paper2_exact_belief_computation_v4.tex in exact
...
tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v4.tex"),
           encoding="utf-8").read()
...
NEEDLES = [
    ...
    "executes the series' first verification script",
...
check("code pointer: the verification script named exactly once",
      tnorm.count("paper2_exact_belief_computation_v4_verification.py") == 1)
...
raw_tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v4.tex"),
               "rb").read()
