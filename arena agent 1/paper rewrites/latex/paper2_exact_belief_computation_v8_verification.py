...
Re-derives every claim of paper2_exact_belief_computation_v8.tex in exact
...
tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v8.tex"),
           encoding="utf-8").read()
...
check("code pointer: the verification script named exactly once",
      tnorm.count("paper2_exact_belief_computation_v8_verification.py") == 1)
...
raw_tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v8.tex"),
               "rb").read()
