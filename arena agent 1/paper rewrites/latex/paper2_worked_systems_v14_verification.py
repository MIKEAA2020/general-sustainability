...
tex = open(os.path.join(HERE, "paper2_worked_systems_v14.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_worked_systems_v14_verification.py",
    ...
    "distinct-subproblem counts", "paper2_worked_systems_v14_verification.py",
