...
j=1,\dots,m\}$ (Abaee 2026a, Section 2.2), but its worked certificates and
...
(Abaee 2026a, Section 8) the dynamic vector-floor reading reproduces the
...
Abaee 2026a, Section 2.2), and the polyhedral Farkas equivalence for the
...
(Abaee 2026a, Section 2.4): a single moment without a jointly
...
\label{prop:gap}
(The vector instance of the common-action obstruction, Abaee 2026a,
...
instance is the unnormalized form of the worked certificate of Abaee 2026a,
...
defined in Abaee 2026a, Section 8, and restated with full transition data
