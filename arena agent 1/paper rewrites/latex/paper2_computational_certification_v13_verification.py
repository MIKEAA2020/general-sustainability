#!/usr/bin/env python3
"""
Computational viability certification, edition 13 — verification.
...
Layer 2b (edition 13): redesign sensitivities and belief-cell checks —
...
paper2_computational_certification_v13.tex, the separate declaration
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v13.tex",
...
# ---------------- Layer 2b (edition 13): redesign sensitivities + belief cells -----
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v13.tex"),
           encoding="utf-8").read()
tex_raw = tex
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_computational_certification_v13_verification.py",
...
check("ladder cross-references: the contribution list cites the ladder "
      ...
      and tex_raw.count("\\ref{prop:ladder}") == 1,
...
_pars = [f for f in ("paper2_computational_certification_v13.tex",)
         if True]
