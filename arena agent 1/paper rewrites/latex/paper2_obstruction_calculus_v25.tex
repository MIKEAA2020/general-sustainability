...
The question splits naturally. The \emph{sufficiency} direction has a
...
What has been missing is a calculus of obstruction certificates. An obstruction certificate is a checkable witness that no observation-based policy exists --- finite in the polyhedral and finite-fibre cases --- and the argument it makes is that a prescribed class of observation-based policies fails not because a particular policy is bad, but because the information structure leaves no room for any policy. In its polyhedral common-action and certification forms
...
The viability-theory background is Aubin (1991) and Aubin, Bayen, and Saint-Pierre (2011); the approximation of kernels is due to Saint-Pierre (1994). Robust (disturbance-averse) viability is developed in Aubin and
...
timing bound of Theorem~\ref{thm:delayed} --- have not been stated in this form; the elementary facts on which they rest (quantifier commutation and Dini comparison) are classical.
