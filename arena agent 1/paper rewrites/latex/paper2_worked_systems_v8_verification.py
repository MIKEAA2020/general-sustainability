...
paper2_worked_systems_v8.tex, the separate declaration headings, the
...
Run: python3 paper2_worked_systems_v8_verification.py
"""
...
tex = open(os.path.join(HERE, "paper2_worked_systems_v8.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_worked_systems_v8_verification.py",
