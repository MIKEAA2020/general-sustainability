...
witness-growth law of Proposition \ref{prop:pl} is the general behaviour, and the certified two-witness families are structural rather
...
Proposition \ref{cor:closed}, the complete certified table, the
...
form of Proposition
\ref{cor:closed} (on the certified grid the second indicator of the
...
\url{paper2_probabilistic_sufficiency_v10_verification.py} --- which chains
