...
Re-derives every claim of paper2_exact_belief_computation_v7.tex in exact
...
tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v7.tex"),
           encoding="utf-8").read()
...
for _needle in ("The audited structure at a glance", "tab:glance",
                ...
                "paper2_exact_belief_computation_v6_verification.py"):
...
check("code pointer: the verification script named exactly once",
      tnorm.count("paper2_exact_belief_computation_v6_verification.py") == 1)
...
raw_tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v7.tex"),
               "rb").read()
