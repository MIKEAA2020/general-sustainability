#!/usr/bin/env python3
"""
Probabilistic sufficiency for the obstruction calculus — edition 6 verification.
...
tex = open(os.path.join(HERE, "paper2_probabilistic_sufficiency_v6.tex"),
           encoding="utf-8").read()
...
NEEDLES = [
    ...
    "paper2_probabilistic_sufficiency_v6_verification.py",
    "with six results",
...
hyg = True
for fn in ("paper2_probabilistic_sufficiency_v6.tex",
...
_n17 = ["Smallwood and Sondik, 1973", "Bertsekas and Shreve, 1978",
        ...
        "Every theorem, proposition,", "cited rather",
        "paper2_probabilistic_sufficiency_v6_verification.py"]
_x17 = " ".join(tex.split())
