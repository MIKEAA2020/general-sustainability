#!/usr/bin/env python3
"""
Exact belief-state computation at scale II — edition 3 verification.

Re-derives every claim of paper2_exact_belief_computation_v3.tex in exact
...
tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v3.tex"),
           encoding="utf-8").read()
...
check("code pointer: the verification script named exactly once",
      tnorm.count("paper2_exact_belief_computation_v3_verification.py") == 1)
...
raw_tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v3.tex"),
               "rb").read()
