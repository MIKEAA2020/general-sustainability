% Periodic Review as Sampled Governance (paper 5, revision v32): redundancy sweep, accessible abstract, and readability revision with line numbers for review.
...
Fisheries are managed on a schedule: scientists assess fish
...
models of management response assume otherwise: they treat
...
We model a fish stock harvested under effort held fixed between
...
scale those records never specify; at an alternative scale every
...
On the empirical side, a spectral screen of 42 annually assessed
...
What decides whether management stabilises or destabilises a
...
rounded values from the assessment table (e.g. underlying values 381.95, 101.05, 30.55 kt). The
