...
% Amin Abaee. Revision v40 (JEDC/elsarticle; Figure 1 re-rendered: dip labels in whitespace, reserve gauge as separate axes). Compiles with tectonic, pdflatex, or xelatex.
