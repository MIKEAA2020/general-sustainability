#!/usr/bin/env python3
"""
Worked-systems audit, edition 4 — verification.
...
paper2_worked_systems_v4.tex, the separate declaration headings, the
...
tex = open(os.path.join(HERE, "paper2_worked_systems_v4.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "alternation-forced pair", "4 \\times 4", "12|21", "13|21", "13|31",
    ...
    "paper2_worked_systems_v4_verification.py",
