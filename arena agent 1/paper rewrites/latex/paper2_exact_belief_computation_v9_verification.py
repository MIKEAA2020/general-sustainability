...
Re-derives every claim of paper2_exact_belief_computation_v9.tex in exact
...
tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v9.tex"),
           encoding="utf-8").read()
...
for _needle in ("The audited structure at a glance", "tab:glance",
                ...
                "(Minato, 1993)",
                "Minato, S. (1993)",
                "paper2_exact_belief_computation_v9_verification.py"):
...
check("code pointer: the verification script named exactly once",
      tnorm.count("paper2_exact_belief_computation_v9_verification.py") == 1)
...
raw_tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v9.tex"),
               "rb").read()
