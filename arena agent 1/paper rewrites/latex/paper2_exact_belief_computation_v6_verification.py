...
Re-derives every claim of paper2_exact_belief_computation_v6.tex in exact
...
tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v6.tex"),
           encoding="utf-8").read()
...
raw_tex = open(os.path.join(HERE, "paper2_exact_belief_computation_v6.tex"),
               "rb").read()
