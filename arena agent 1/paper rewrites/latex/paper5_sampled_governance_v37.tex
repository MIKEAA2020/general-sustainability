...
biomass, subject to a minimum catch provision) has a post-rule coefficient of variation of 0.387 (calculated here; 0.394 on the current ICES vintage, Supplementary S4) with a 10--15 yr fluctuation. The estimated implementation lag, however, is approximately
...
Icelandic haddock under a related rule has a post-2013 (own-HCR) SSB coefficient of variation of 0.24, lower despite higher recruitment variability.
