...
paper2_computational_certification_v11.tex, the separate declaration
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v11.tex",
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v11.tex"),
           encoding="utf-8").read()
tex_raw = tex
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_computational_certification_v11_verification.py",
...
_pars = [f for f in ("paper2_computational_certification_v11.tex",)
         if True]
