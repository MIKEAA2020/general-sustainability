#!/usr/bin/env python3
"""
Probabilistic sufficiency for the obstruction calculus — edition 4 verification.
...
tex = open(os.path.join(HERE, "paper2_probabilistic_sufficiency_v4.tex"),
           encoding="utf-8").read()
...
NEEDLES = [
    ...
    "paper2_probabilistic_sufficiency_v4_verification.py",
    "with six results",
...
hyg = True
for fn in ("paper2_probabilistic_sufficiency_v4.tex",
