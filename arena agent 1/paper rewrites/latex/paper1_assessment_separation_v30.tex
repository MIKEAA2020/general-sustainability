...
% Amin Abaee. Revision v30 (review build with line numbers). Compiles with tectonic, pdflatex, or xelatex.
...
Sustainability assessments routinely boil many different things into a
single index: money, natural resources, clean water, biodiversity; The
assumption is that a shortfall in one can always be made up by a
surplus in another. This paper proves that the assumption fails in
