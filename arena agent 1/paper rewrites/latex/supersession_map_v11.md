# Supersession Map — Programme-Wide Banner (v11)
...
| Retired this round | Superseded by | Note |
|---|---|---|
| applied_regime_viability_v4.* | applied_regime_viability_v5.* (tex/pdf/verification) | §D roadmap conducted: window profile, band certificates, vintage typology, backward extension, scope sentences; 185/185 → 229/229; 6 → 7 pp |
| paper2_obstruction_calculus_followup_roadmap_v40.md | paper2_obstruction_calculus_followup_roadmap_v41.md | round-22 update |
| supersession_map_v10.md | supersession_map_v11.md | this banner |

New artifacts: `paperE1_calibration_data_v2_ram_panel_v1.csv` (locked panel
extract; RAM Legacy v4.66, DOI 10.5281/zenodo.14043031, md5
