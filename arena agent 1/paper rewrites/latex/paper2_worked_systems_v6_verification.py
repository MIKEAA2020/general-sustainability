#!/usr/bin/env python3
"""
Worked-systems audit, edition 6 — verification.
...
paper2_worked_systems_v6.tex, the separate declaration headings, the
...
tex = open(os.path.join(HERE, "paper2_worked_systems_v6.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "one previous-action register per information state", "memoryless and decentralized", "two-by-two product", "row labels, agency 2's the column labels", "\\ell_1", "alternation-forced pair", "single previous-action register", "4 \\times 4", "12|21", "13|21", "13|31",
    ...
    "paper2_worked_systems_v6_verification.py",
