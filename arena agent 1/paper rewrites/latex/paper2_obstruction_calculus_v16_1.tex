...
% Amin Abaee. Revision v16.1 (symbol collisions from v16 fixed: Farkas lambda->mu, observer decay alpha->lambda, estimation error eta->zeta, patch coupling gamma->kappa). Compiles with tectonic, pdflatex, or xelatex.
