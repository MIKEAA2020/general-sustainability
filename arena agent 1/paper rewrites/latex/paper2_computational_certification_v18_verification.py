#!/usr/bin/env python3
"""
Computational viability certification, edition 17 — verification.
...
Layer 2b (edition 17): redesign sensitivities and belief-cell checks —
...
paper2_computational_certification_v18.tex, the separate declaration
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v18.tex",
...
# ---------------- Layer 2b (edition 17): redesign sensitivities + belief cells -----
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v18.tex"),
           encoding="utf-8").read()
tex_raw = tex
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_computational_certification_v18_verification.py",
...
_pars = [f for f in ("paper2_computational_certification_v18.tex",)
         if True]
