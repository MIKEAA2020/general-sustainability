...
Standard library only. Run: python3 paperE1_cod_forecast_ladder_v51_verification.py
"""
...
tex = open(os.path.join(HERE, "paperE1_cod_forecast_ladder_v51.tex"), encoding="utf-8").read()
