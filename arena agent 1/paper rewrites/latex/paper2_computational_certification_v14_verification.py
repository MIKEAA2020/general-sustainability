#!/usr/bin/env python3
"""
Computational viability certification, edition 14 — verification.
...
Layer 2b (edition 14): redesign sensitivities and belief-cell checks —
...
paper2_computational_certification_v14.tex, the separate declaration
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v14.tex",
...
# ---------------- Layer 2b (edition 14): redesign sensitivities + belief cells -----
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v14.tex"),
           encoding="utf-8").read()
tex_raw = tex
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_computational_certification_v14_verification.py",
...
_pars = [f for f in ("paper2_computational_certification_v14.tex",)
         if True]
