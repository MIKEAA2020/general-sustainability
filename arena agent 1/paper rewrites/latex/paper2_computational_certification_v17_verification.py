...
paper2_computational_certification_v17.tex, the separate declaration
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v17.tex",
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v17.tex"),
           encoding="utf-8").read()
tex_raw = tex
tex = " ".join(tex.split())
NEEDLES = [
...
_pars = [f for f in ("paper2_computational_certification_v17.tex",)
         if True]
