#!/usr/bin/env python3
"""
Worked-systems audit, edition 7 — verification.
...
paper2_worked_systems_v7.tex, the separate declaration headings, the
...
Run: python3 paper2_worked_systems_v7_verification.py
"""
...
tex = open(os.path.join(HERE, "paper2_worked_systems_v7.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
    ...
    "paper2_worked_systems_v7_verification.py",
