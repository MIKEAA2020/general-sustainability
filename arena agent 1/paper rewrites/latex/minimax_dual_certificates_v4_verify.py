#!/usr/bin/env python3
"""
Minimax dual certificates v4 — the general finite-sequence envelope —
...
# ---------------- G6: text ----------------
tex = open("minimax_dual_certificates_v4.tex", encoding="utf-8").read()
tn = " ".join(tex.split())
for needle in ["The general finite-sequence envelope",
               ...
               "minimax\\_dual\\_certificates\\_v4\\_verify.py"]:
