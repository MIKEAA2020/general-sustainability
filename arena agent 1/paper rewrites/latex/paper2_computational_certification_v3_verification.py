#!/usr/bin/env python3
"""
Computational viability certification, edition 3 — verification.
...
paper2_computational_certification_v3.tex, the separate declaration
headings, and the responsibility wording.

Exact rational/integer arithmetic except solver outputs; stdlib only;
deterministic.
Run: python3 paper2_computational_certification_v3_verification.py
"""
...
import re as _re
hyg = True
for f in ("paper2_computational_certification_v3.tex",
          "paper2_computational_certification_v3_supplementary.tex"):
...
tex = open(os.path.join(HERE, "paper2_computational_certification_v3.tex"),
           encoding="utf-8").read()
tex = " ".join(tex.split())
NEEDLES = [
