...
R_U \|k_a - k_{a'}\|_{L^1} + |\beta_a - \beta_{a'}|\), the equicontinuity
...
\(\tfrac12 + (\beta + \tfrac{26}{100}) = \tfrac15 > 0\)). All dimension counts
...
\url{paper2_computational_certification_v7_verification.py},
