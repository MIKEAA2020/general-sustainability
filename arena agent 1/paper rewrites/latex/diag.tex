...
% Amin Abaee. Revision v35 (JEDC/elsarticle; margin-set notation D->mathD, table label, longtable->tabular so the policy table is Table 1). Compiles with tectonic, pdflatex, or xelatex.
...
\newlength{\mytestw}
\setlength{\mytestw}{(\columnwidth - 4\tabcolsep) * \real{0.3333}}
\textbf{DIAG} colw=\the\columnwidth{} lw=\the\linewidth{} textw=\the\textwidth{} tabc=\the\tabcolsep{} ptest=\the\mytestw{}
