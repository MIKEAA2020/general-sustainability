...
- **No claim about the convex hull of the menu.** The witness menu is a finite four-action set; time-shared or fractional action policies are not members of the action space, and whether convexification of the menu would collapse the acceptance gap is not analyzed here.
