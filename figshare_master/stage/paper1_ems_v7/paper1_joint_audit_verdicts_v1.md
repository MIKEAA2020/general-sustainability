...
1. **Renaming.** The manuscript is paper 1 in extended, venue-agnostic
   ...
   note above.
2. **Venue-agnostic master created** (the previously missing deliverable):
   ...
   numbered sections, standard natbib); staged for figshare at
   `figshare_deposit/stage/master_v1/`.
