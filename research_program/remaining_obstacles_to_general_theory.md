...
1. **A1 continuum lift** (piecewise-Chebyshev execution) — unlocks the certified chain and B4; highest-leverage mathematics. **Stage 1 EXECUTED 2026-08-26** (substrate + local-gain diagnostic: the O(1)-local-gain premise confirmed with margin, the coupling band measured at 97 segments, the defect levels ~7.9e-9 — `a021_c4/c4_piecewise_chebyshev_stage1.json`); Stages 2–4 remain.
...
3. **Wave-0 close**: freeze + match the Wave E specification (Part III — artifact level done, paper-support rows open), row-verify the 409-row concordance (machine layer done; the 336+45 scientific row-closure states open), build C-g manifests (done, 47 artifacts).
