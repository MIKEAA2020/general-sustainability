...
src = Path('revised_manuscript_traceability.md')
out = Path('revised_manuscript_traceability.docx')
...
run = footer.add_run('Revised manuscript traceability · 17 August 2026     ')
run.font.size = Pt(8)
...
core.title = 'Traceability Report for the Revised Sustainability Manuscript'
