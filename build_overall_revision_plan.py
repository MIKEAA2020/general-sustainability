...
src = Path('overall_revision_plan.md')
out = Path('overall_revision_plan.docx')
...
run = footer.add_run('Overall revision plan · 14 August 2026     ')
run.font.size = Pt(8)
...
core.title = 'Overall Revision Plan for Toward a General Theory of Sustainability'
core.subject = 'Robust viability in dependency-closed ecological, economic, and social systems'
core.author = '[Author name]'
core.comments = 'Integrated architectural revision plan'
