...
src = Path('joint_architectural_audit_evaluation.md')
out = Path('joint_architectural_audit_evaluation.docx')
...
run = footer.add_run('Joint architectural audit evaluation · 14 August 2026     ')
run.font.size = Pt(8)
