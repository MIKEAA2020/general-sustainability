...
src = Path('general_theory_of_sustainability_v0.2_comprehensive.md')
out = Path('general_theory_of_sustainability_v0.2_comprehensive.docx')
...
run = footer.add_run('Comprehensive working manuscript · Version 0.2 · 14 August 2026     ')
run.font.size = Pt(8)
...
core.title = 'Toward a General Theory of Sustainability'
core.subject = 'Robust viability in dependency-closed ecological, economic, and social systems'
core.author = '[Author name]'
core.comments = 'Comprehensive working manuscript, Version 0.2'
