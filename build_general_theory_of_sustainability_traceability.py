...
src = Path('general_theory_of_sustainability_traceability.md')
out = Path('general_theory_of_sustainability_traceability.docx')
...
run = footer.add_run('Companion traceability report · 14 August 2026     ')
run.font.size = Pt(8)
...
core.comments = 'Companion traceability report'
